...
public class AudioPlayerService extends Service {
    ...
    private int count = 0;
    private static int stateService = NotifConstants.STATE_SERVICE.NOT_CONNECTED;
    ...
    public void onCreate() {
        ...
        stateService = NotifConstants.STATE_SERVICE.NOT_CONNECTED;
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        switch (intent.getAction()) {
            case NotifConstants.ACTION.START_ACTION:
                ...
                connect();
                break;
            case NotifConstants.ACTION.STOP_ACTION:
        ...
        new Handler().postDelayed(
                new Runnable() {
                    public void run() {
                        ...
                        stateService = NotifConstants.STATE_SERVICE.CONNECTED;
                        startForeground(NotifConstants.NOTIFICATION_ID_FOREGROUND_SERVICE, prepareNotification());
                    }
                }, 10000);
    ...
    private Notification prepareNotification() {
        ...
        notificationIntent.setAction(NotifConstants.ACTION.MAIN_ACTION);
        ...
        stopIntent.setAction(NotifConstants.ACTION.STOP_ACTION);
        ...
        // if it is connected
        switch(stateService) {
            case NotifConstants.STATE_SERVICE.NOT_CONNECTED:
                remoteViews.setTextViewText(R.id.tv_state, "DISCONNECTED");
                break;
            case NotifConstants.STATE_SERVICE.CONNECTED:
