...
import com.aliumujib.tabbarseed.di.components.DaggerApplicationComponent
...
class ApplicationClass : DaggerApplication(){
    ...
    override fun applicationInjector(): AndroidInjector<out DaggerApplication> = DaggerApplicationComponent.builder().bindApplicationInstance(this).buildApplicationComponent()
